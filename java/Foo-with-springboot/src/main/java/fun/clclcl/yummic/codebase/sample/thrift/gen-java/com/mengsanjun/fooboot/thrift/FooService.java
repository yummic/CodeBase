 ...
 *  @generated
 */
package com.mengsanjun.fooboot.thrift;
...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2019-12-09")
public class FooService {

  public interface Iface {

    public String getMessage(String info, int sleep) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getMessage(String info, int sleep, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String getMessage(String info, int sleep) throws org.apache.thrift.TException
    {
      send_getMessage(info, sleep);
      return recv_getMessage();
    }

    public void send_getMessage(String info, int sleep) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getMessage(String info, int sleep, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getMessage_call method_call = new getMessage_call(info, sleep, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getMessage_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String info;
      private int sleep;
      public getMessage_call(String info, int sleep, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getMessage<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getMessage_args> {
      ...
      public getMessage_result getResult(I iface, getMessage_args args) throws org.apache.thrift.TException {
        getMessage_result result = new getMessage_result();
        result.success = iface.getMessage(args.info, args.sleep);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getMessage<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getMessage_args, String> {
      ...
      public void start(I iface, getMessage_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.getMessage(args.info, args.sleep,resultHandler);
      }
    }
  ...
  public static class getMessage_args implements org.apache.thrift.TBase<getMessage_args, getMessage_args._Fields>, java.io.Serializable, Cloneable, Comparable<getMessage_args>   {
    ...
    private static final org.apache.thrift.protocol.TField SLEEP_FIELD_DESC = new org.apache.thrift.protocol.TField("sleep", org.apache.thrift.protocol.TType.I32, (short)2);
    ...
    private static final int __SLEEP_ISSET_ID = 0;
    ...
    static {
      ...
      tmpMap.put(_Fields.SLEEP, new org.apache.thrift.meta_data.FieldMetaData("sleep", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    public getMessage_args setInfo(String info) {
      this.info = info;
      return this;
    }
    ...
    public getMessage_args setSleep(int sleep) {
      this.sleep = sleep;
      setSleepIsSet(true);
      return this;
    }
    ...
    public void unsetSleep() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SLEEP_ISSET_ID);
    }

    /** Returns true if field sleep is set (has been assigned a value) and false otherwise */
    public boolean isSetSleep() {
      return EncodingUtils.testBit(__isset_bitfield, __SLEEP_ISSET_ID);
    }

    public void setSleepIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SLEEP_ISSET_ID, value);
    }
    ...
    public boolean equals(getMessage_args that) {
      ...
      boolean this_present_sleep = true;
      boolean that_present_sleep = true;
      if (this_present_sleep || that_present_sleep) {
        if (!(this_present_sleep && that_present_sleep))
          return false;
        if (this.sleep != that.sleep)
          return false;
      }
